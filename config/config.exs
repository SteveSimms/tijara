...
config :ex_cldr, default_backend: Tijara.Cldr
...
config :tijara, TijaraWeb.Endpoint,
  ...
  render_errors: [
    formats: [html: TijaraWeb.ErrorHTML, json: TijaraWeb.ErrorJSON],
    layout: false
  ],
  pubsub_server: Tijara.PubSub,
  live_view: [signing_salt: "RDYzpYeM"]
...
config :tijara, Tijara.Mailer, adapter: Swoosh.Adapters.Local
