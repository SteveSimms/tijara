defmodule Tijara.Ledger.Balance do
  use Ash.Resource,
  ...
  balance do
    transfer_resource Tijara.Ledger.Transfer
  ...
  relationships do
    belongs_to :transfer, Tijara.Ledger.Transfer do
      attribute_type AshDoubleEntry.ULID
      allow_nil? false
      attribute_writable? true
    end

    belongs_to :account, Tijara.Ledger.Account do
      allow_nil? false
      attribute_writable? true
    end
  end
